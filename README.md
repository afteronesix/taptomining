...
Welcome to the TapCoin Mining Game! This project is a fun, interactive game that combines the addictive nature of clicker games with the concept of mining cryptocurrency using a simple blockchain. Players can mine TapCoin by clicking a button, sell the mined coins for gems, and purchase helpers to automate the mining process.
...
- **Coin Price Fluctuation:** TapCoin price fluctuates randomly between 0.1 and 1.0, displayed on a live chart.
...
```sh
git clonehttps://github.com/afteronesix/taptomining.git
```
...
- Click "Mine TapCoin" to start testing nonces (proof-of-work values) against the current difficulty target.
...
- **Dynamic Pricing:** TapCoin price fluctuates between 0.1 and 1.0 gems every 2 seconds.
